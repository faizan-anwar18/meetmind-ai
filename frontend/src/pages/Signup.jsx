...
export default function Signup() {
    ...
    return (
        ...
        <div className="relative min-h-screen bg-slate-950 flex items-center justify-center px-6 overflow-hidden">
            ...
            <div className="absolute w-[650px] h-[650px] bg-cyan-500/10 rounded-full blur-[180px]"></div>
            ...
            <div className="relative z-10 w-full max-w-md bg-slate-900/90 backdrop-blur-xl border border-slate-700 rounded-3xl p-10 shadow-2xl">
                ...
                <form className="space-y-5">
                    ...
                    <button
                        className="w-full bg-gradient-to-r from-blue-600 via-cyan-500 to-purple-500 py-3 rounded-xl text-white font-semibold hover:scale-105 transition"
                    >
                        Create Account
                    </button>
                ...
                <button className="w-full border border-slate-700 py-3 rounded-xl text-white hover:bg-slate-800 transition">
